...
fromrule=off,  % Trennlinie unter dem Briefkopf
foldmarks=true
}
...
\setkomavar{date}{\color{red} Entwurf vom \today}       % Datum

\setkomavar{title}{\vspace{9pt}}  % Ersatz für hässliche Titelzeile

% % For multiple recipients, add csv and use this:
% \usepackage{datatool}
% \DTLsetseparator{,}
...
%     \Title=Title,\Name=Name,\Street=Street,\Zip=Zip,\City=City}{%

% Add closing } after letter!
