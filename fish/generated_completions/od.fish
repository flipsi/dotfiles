...
complete -c od -s A -l address-radix --description 'decide how file offsets are printed.'
...
complete -c od -s S -l 'strings[' --description 'output strings of at least BYTES graphic chars.'
...
complete -c od -s w -l 'width[' --description 'output BYTES bytes per output line.'
complete -c od -l traditional --description 'accept arguments in traditional form.'
...
complete -c od -s a --description 'same as -t a,  select named characters, ignorin… [See Man Page]'
complete -c od -s b --description 'same as -t o1, select octal bytes.'
complete -c od -s c --description 'same as -t c,  select ASCII characters or backslash escapes.'
