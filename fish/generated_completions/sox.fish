...
complete -c sox -s D -l no-dither --description 'Disable automatic dither\\*msee `Dither\' above.'
...
complete -c sox -l interactive --description 'Deprecated alias for --no-clobber.'
...
complete -c sox -s i --description 'and.'
...
complete -c sox -s H --description '`Brick-wall\' quefrency of high-pass lifter used… [See Man Page]'
