...
complete -c sg_read_long -s o -l out --description 'instead of outputting ASCII hex to stdout, send… [See Man Page]'
complete -c sg_read_long -s p -l pblock --description 'sets the \'PBLOCK\' bit in the SCSI READ LONG command.'
complete -c sg_read_long -s r -l readonly --description 'opens the DEVICE read-only rather than read-wri… [See Man Page]'
