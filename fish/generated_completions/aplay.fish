...
complete -c aplay -s B -l buffer-time --description 'Buffer duration is # microseconds If no buffer … [See Man Page]'
complete -c aplay -l period-size --description 'Distance between interrupts is # frames If no p… [See Man Page]'
complete -c aplay -l buffer-size --description 'Buffer duration is # frames If no buffer time a… [See Man Page]'
complete -c aplay -s A -l avail-min --description 'Min available space for wakeup is # microseconds.'
complete -c aplay -s R -l start-delay --description 'Delay for automatic PCM start is # microseconds… [See Man Page]'
...
complete -c aplay -s P --description 'Playback.'
complete -c aplay -s C --description 'Record.'
...
complete -c aplay -l test-nowait --description 'Do not wait for the ring buffer--eats the whole CPU.'
complete -c aplay -l max-file-time --description 'While recording, when the output file has been … [See Man Page]'
complete -c aplay -l process-id-file --description 'aplay writes its process ID here, so other prog… [See Man Page]'
complete -c aplay -o c2 -o 'r44100]' --description '.'
complete -c aplay -o 'f44100]' --description '.'
complete -c aplay -o 'r48000]' --description '.'
complete -c aplay -l use-strftime --description 'When recording, interpret %-codes in the file n… [See Man Page]'
