...
complete -c setfacl -l mask --description 'Do recalculate the effective rights mask, even … [See Man Page]'
...
complete -c setfacl -l set -l set-file --description 'options set the ACL of a file or a directory.'
