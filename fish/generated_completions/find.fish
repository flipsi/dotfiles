...
complete -c find -s H --description 'Do not follow symbolic links, except while proc… [See Man Page]'
complete -c find -s D --description 'Print diagnostic information; this can be helpf… [See Man Page]'
...
complete -c find -s O --description 'must appear before the first path name, if at all.'
complete -c find -o noleaf --description 'If you later use the .'
complete -c find -o type --description 'predicate will always match against the type of… [See Man Page]'
...
complete -c find -o newer --description 'will be dereferenced, and the timestamp will be… [See Man Page]'
...
complete -c find -o xtype --description 'tests are performed after any tests based only … [See Man Page]'
complete -c find -s o --description 'predicates which are likely to succeed are eval… [See Man Page]'
complete -c find -s a --description 'predicates which are likely to fail are evaluated earlier.'
complete -c find -o and --description 'is assumed where the operator is omitted.'
complete -c find -o prune --description '.'
complete -c find -o daystart --description '.'
complete -c find -o regextype --description 'the options affect all tests, including tests s… [See Man Page]'
complete -c find -s d --description 'A synonym for -depth, for compatibility with Fr… [See Man Page]'
...
complete -c find -o depth --description 'Process each directory\'s contents before the directory itself.'
complete -c find -o delete --description '.'
complete -c find -o help -l help --description 'Print a summary of the command-line usage of find and exit.'
complete -c find -o ignore_readdir_race --description 'Normally, find will emit an error message when … [See Man Page]'
complete -c find -o mindepth --description 'Do not apply any tests or actions at levels les… [See Man Page]'
complete -c find -o mount --description 'Don\'t descend directories on other filesystems.'
...
complete -c find -o samefile --description 'allow comparison between the file currently bei… [See Man Page]'
...
complete -c find -o executable --description 'Matches files which are executable and director… [See Man Page]'
complete -c find -o perm --description 'test ignores.'
complete -c find -o false --description 'Always false.'
complete -c find -o fstype --description 'File is on a filesystem of type type.'
...
complete -c find -o ipath --description 'Behaves in the same way as .'
complete -c find -o iwholename --description 'This option is deprecated, so please do not use it.'
complete -c find -o wholename --description 'but the match is case insensitive.'
complete -c find -o links --description 'File has n links.'
complete -c find -o path --description 'Braces are not recognised as being special, des… [See Man Page]'
...
complete -c find -s g --description 'which matches any file with group write permission.'
...
complete -c find -o size --description 'File uses n units of space.'
...
complete -c find -o used --description 'File was last accessed n days after its status … [See Man Page]'
...
complete -c find -o fprint --description 'The output file is always created, even if the … [See Man Page]'
...
complete -c find -o 'fstype.' --description '%g File\'s group name, or numeric group ID if th… [See Man Page]'
...
complete -c find -o 'ok;' --description 'while the `LC_MESSAGES\' variable selects the ac… [See Man Page]'
...
complete -c find -o 'iregex	3.8' --description '.'
