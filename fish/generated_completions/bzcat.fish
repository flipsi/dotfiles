...
complete -c bzcat -s z -l compress --description 'The complement to -d: forces compression, regar… [See Man Page]'
complete -c bzcat -s t -l test --description 'Check integrity of the specified file(s), but d… [See Man Page]'
complete -c bzcat -s f -l force --description 'Force overwrite of output files.'
complete -c bzcat -s k -l keep --description 'Keep (don\'t delete) input files during compress… [See Man Page]'
complete -c bzcat -s s -l small --description 'Reduce memory usage, for compression, decompres… [See Man Page]'
complete -c bzcat -s q -l quiet --description 'Suppress non-essential warning messages.'
complete -c bzcat -s v -l verbose --description 'Verbose mode -- show the compression ratio for … [See Man Page]'
complete -c bzcat -s h -l help --description 'Print a help message and exit.'
